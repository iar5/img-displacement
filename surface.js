 ...
 * 
 * ERWEITERUNGEN
 * - Steuerung: leichte Rotation/Wackeln in allen Seiten, ziehbar -> geht zurück, wenn losgelassen
 * - update(img) mit sichtbarer Vertice-Veränderung, Drehung etc. beibehalten
 * - Lag bei update(img) verhindert durch Berechnung der Bilddaten in Webworker
 * - Video: Vertices bleiben gleich, nur Farbe wird geupdated
 * - Transition in Farbe und Tiefe, wenn Dimensionen von beiden Bildern gleich sind
 * 
 * - leichtes dings (displacement) über Noise-Funktion wie im gespeicherten IG-Beitrag
...
import { loadImage, getImageData } from './lib/image.js'
import { createProgramFromSource, destroyGl } from './lib/webgl.js'
